...
void draw_box(const std::string& text, bool solid = false, const std::string& bg_color = "bg_blue", const std::string& text_color = "white") {
    ...
    std::string text_code = COLOR_MAP.count(text_color) ? COLOR_MAP.at(text_color) : COLOR_MAP.at("white");
